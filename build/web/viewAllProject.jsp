...
<html>
    ...
    <body>
        ...
        <br><br>
        <h1 style="text-align: center;font-family: 'Montserrat'">&#8203;All Projects</h1>
        <%
        ...
        %>
                        ...
                        <tr>
                            ...
                            <td><a href="updateProjectDetails.jsp?project=<%= rs.getString("name") %>"><button class="btn btn-info">Update</button></a></td>
                            <td><a href="deleteProjectDetails.jsp?project=<%= rs.getString("name") %>"><button class="btn btn-danger">Delete</button></a></td>
