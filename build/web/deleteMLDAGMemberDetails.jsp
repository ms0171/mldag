    ...
    <body>
        <%
            if(session.getAttribute("view")!=null){
                ...
                while(rs.next()){
             %>   
        <form action="executeMLDAGMemberDelete.jsp" method="post">
            ...
            <table class="table table-striped table-bordered">
                ...
                <tr>
                    ...
                    <td><input type="text" name="studentId" id="studentId" value="<%= rs.getString("studentid") %>" disabled></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="institutionName" id="institutionName" value="<%= rs.getString("institutename") %>" disabled></td>
                </tr>
                <tr>
                    <td><h3>Update Gender</h3></td>
                    <td><input type="radio" name="gender" id="gender" checked value="male" disabled>Male<br>
                    <input type="radio" name="gender" id="gender" value="female" disabled>Female</td>
                </tr>
                <tr>
                    <td><h3>Update Graduation Level</h3></td>
                    <td><input type="radio" name="graduation" id="graduation" checked value="btech" disabled>B.Tech<br>
                        <input type="radio" name="graduation" id="graduation" value="mtech" disabled>M.Tech<br>
                    <input type="radio" name="graduation" id="graduation" value="phd" disabled>PHD</td>
                </tr>
                <tr>
                 ...
                 <tr>
                    ...
                    <td><input type="text" name="cgpa" id="cgpa" value="<%= rs.getString("cgpa") %>" disabled></td>
                </tr>
                 <tr>
                 ...
                 <tr>
                    ...
                    <td><textarea name="reason" id="reason" rows="5" cols="40" disabled><%= rs.getString("reason") %></textarea></td>
                </tr>
            </table>
