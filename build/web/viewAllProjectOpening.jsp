...
<html>
    ...
    <body>
        ...
        <br><br>
        <h1 style="text-align: center;font-family: 'Montserrat'">&#8203;All Project Opening</h1>
        <%
        ...
        %>
                        ...
                        <tr>
                            ...
                            <td><a href="updateProjectOpeningDetails.jsp?title=<%= rs.getString("title") %>"><button class="btn btn-info">Update</button></a></td>
                            <td><a href="deleteProjectOpeningDetails.jsp?title=<%= rs.getString("title") %>"><button class="btn btn-danger">Delete</button></a></td>
