...
<html>
    <head>
        ...
        <title>Team Member Login-MLDAG Charusat</title>
    </head>
    <body>
        <%
            ...
            ResultSet admin = st.executeQuery("select distinct username,password,name,designation,department,institute,qualification,email,researchinterest from teammembers where user='teamMember'");
