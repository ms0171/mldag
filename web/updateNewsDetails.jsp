    ...
    <body>
        <%
            if(session.getAttribute("view")!=null){
                ...
                while(rs.next()){
             %>   
             <form action="executeNewsUpdate.jsp" method="post">
                 <h1 style="font-family: 'Montserrat';text-align: center;">&#8203;Update News</h1>
            <table style="font-family: 'Lora';" class="table table-striped">
                <tr>
                    <td><h3>Update Title</h3></td>
                    <td><textarea name="title" rows="5" cols="50"><%= rs.getString("news") %></textarea></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><input type="hidden" name="news" value="<%= news %>"></td>
                </tr>
                <br> 
            </table>
            <input type="submit" name="button" value="Update News" class="btn btn-success">
        </form>
        <%
                }
            }
