    ...
    <body>
        <%
            if(session.getAttribute("view")!=null){
                ...
                while(rs.next()){
             %>   
             <form action="executeProjectOpeningDelete.jsp" method="post">
                 <h1 style="font-family: 'Montserrat';text-align: center;">&#8203;Delete Project Opening</h1>
            <table style="font-family: 'Lora';" class="table table-striped">
                <tr>
                    <td><h3>Update Title</h3></td>
                    <td><textarea name="title" rows="5" cols="50" disabled><%= rs.getString("title") %></textarea></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><input type="hidden" name="oldTitle" value="<%= rs.getString("title") %>"></td>
                </tr>
                <br> 
            </table>
            <input type="submit" name="button" value="Delete Project Opening" class="btn btn-danger">
        </form>
        <%
            }
                    }
